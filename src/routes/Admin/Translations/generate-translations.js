(async () => {
    ...
    const translations = {
        ...
        editor: {
            inputHelper: ["Eingabemaske", "Input mask"],
            inputHelperStatic: ["Fix Text", "Static text"],
            inputHelperText: ["Text", "Text"],
            inputHelperNumber: ["Zahl", "Number"],
            inputHelperCheckbox: ["Optionskästchen", "Option checkbox"],
            inputHelperDatetime: ["Zeit/Datum", "Time/Date"],
            inputHelperColor: ["Farbe", "Color"],
            inputHelperList: ["Listauswahl", "List selection"],
            ihOptionText: ["Text", "Text"],
            ihOptionDescription: ["Beschreibung", "Description"],
            ihOptionHideEmptyCell: ["Zelle verstecken wenn leer", "Hide cell when empty"],
            ihOptionIsRequired: ["Muss befüllt werden", "Needs to filled out"],
            ihOptionMinValue: ["Minimalwert", "Minimum value"],
            ihOptionMaxValue: ["Maximalwert", "Maximum value"],
            ihOptionDefaultValue: ["Standardwert", "Default value"],
            ihOptionStepSize: ["Schrittgröße", "Stepsize"],
            ihOptionInteger: ["Ganzzahlswert", "Hole number value"],
            ihOptionTextColor: ["Textfarbe", "Text color"],
            ihOptionFontSize: ["Schriftgröße", "Fontsize"],
            ihOptionMaxLenght: ["Maximale Zeichenmenge", "Maximum character count"],
            ihOptionRowsShown: ["Zeilen angezeigt", "Rows shown"],
            ihOptionFontSize: ["Schriftgröße", "Fontsize"],
            ihOptionDatetimeDate: ["Datum", "Date"],
            ...
            ihOptionListDisplayType: ["Darstellungsart", "Display type"],
            ihOptionListDisplayList: ["Liste", "List"],
            ihOptionListDisplayHRadio: ["Horizontale Schaltknöpfe", "Horizontal radiobuttons"],
            ihOptionListDisplayVRadio: ["Vertikale Schaltknöpfe", "Vertical radiobuttons"],
        ...
        common: {
            ...
            theEntry: ["den Eintrag", "the entry"],
            doNotShowAgain: ["Nicht wieder anzeigen!", "Do not show again!"],
            createNewTemplate: ["Neue Vorlage erstellen", "Create new template"],
            createNewFolder: ["Neuen Ordner erstellen", "Create new folder"],
            foldername: ["Ordner name", "Folder name"],
            createNewEntry: ["Neuen Eintrag erstellen", "Create new entry"],
            list: ["Liste", "list"],
            hideList: ["Liste verstecken", "Hide list"],
            showList: ["Liste anzeigen", "Show list"],
            ...
            row_zero: ["Zeilen", "Rows"],
            row_one: ["Zeile", "Row"],
            row_other: ["Zeilen", "Rows"],
            cell_zero: ["Zellen", "Cells"],
            cell_one: ["Zelle", "Cell"],
            cell_other: ["Zellen", "Cells"],
